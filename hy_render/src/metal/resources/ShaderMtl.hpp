 ...
 * @brief Metal 着色器实现
 */
class ShaderMtl : public HYShader {
public:
    ShaderMtl(const ShaderDesc& desc, void* device);
    virtual ~ShaderMtl();
...
private:
    ...
    ShaderDesc mDesc;
    void* mLibrary = nullptr;        // id<MTLLibrary>
    void* mVertexFunction = nullptr; // id<MTLFunction>
    void* mFragmentFunction = nullptr; // id<MTLFunction>
